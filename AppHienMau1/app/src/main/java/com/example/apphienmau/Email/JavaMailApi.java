package com.example.apphienmau.Email;
...
public class JavaMailApi extends AsyncTask<Void, Void, Void> {
    ...
    protected void onPreExecute() {
        ...
        progressDialog.setMessage("Đang gởi mail...");
        progressDialog.setTitle("Đang gởi mail đến người cho...");
        progressDialog.show();
        super.onPreExecute();
    }
